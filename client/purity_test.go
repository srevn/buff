...
// TestImportDiscipline pins the client's production dependency budget. The client is a pure wire
// peer of the server: it may use stdlib and the two leaf packages both sides share — the domain
...
// not counted against the package.
