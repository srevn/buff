...
// liveness, the advertised api versions, and the capability list it reports for diagnosis. Unlike
// the content methods there is no domain type behind it, so this guards the one place the client
// decodes /health directly.
