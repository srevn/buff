...
// TestHealth probes /healthz through the client and checks the operational report it decodes:
...
// it, so this guards the one place the client decodes /healthz directly.
