...
// Health is the server's liveness-and-capability report from /healthz. Unlike the content
...
// Health probes the server's unversioned /healthz endpoint. It is the basis for a version
...
func (c *Client) Health(ctx context.Context) (Health, error) {
	resp, err := c.do(ctx, http.MethodGet, c.base+wire.PathHealthz, nil, nil)
	if err != nil {
		return Health{}, err
	}
